...
class DatabaseAdministration:    
    ...
    def return_database():
        ...
        database = DatabaseAdministration.open_database()
...
class AccountAdministration:
    ...
    def create_account():
        ...
        slt = SaltsHashes.saltValue()     
        
        #Salting and hashing password
        passOne = SaltsHashes.hashValues(uInput, slt)
        ...
        passTwo = SaltsHashes.hashValues(uInputTwo, slt)
    ...
    def login_account():
        ...
        if user in database:
            ...
            passW = SaltsHashes.hashValues(uInput, uSlt)
    ...
    def userAccount(user):
        ...
        if invoke.lower() == "lf":
            print("Logging off...")
            AccountAdministration.create_account()
        elif invoke.lower() == "x":
...
class testing:
    ...
    def main(self):
        AccountAdministration.create_account()
        AccountAdministration.login_account()
