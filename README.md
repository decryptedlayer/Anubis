...
A conceptual quantum resistant peer-to-peer instant messenger utilising a suite of cryptographic algorithms that makes it theoretically infeasable for an adversary to break using a quantum computer.
