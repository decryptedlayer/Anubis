...
For quantum resistant symmetric key based cryptographic algorithms, AES-256 will be used. Though AES-256 is suceptible to Grover's quantum search algorithm, its ability to be conventionally broken by a quantum computer diminishes AES-256 strength to that of AES-128 used today. Though strength will be diminished, effectively breaking AES-256 through practical means will still require some form of exhaustive keyspace seach 
